...
(113, 113, 'Smoked Turkey Croissant | كرواسون تركي مدخن', 14, 'كرواسون مع صدر رومي مدخن وجبنة.', 'Smoked Turkey Croissant.png'),
(114, 114, 'Mixed Cheese Croissant | كرواسون جبن مشكل', 14, 'كرواسون محشو بتشكيلة من الأجبان الثلاثة.', 'Mixed Cheese Croissant.png'),
(115, 115, 'Plain Patisserie | باتيه سادة', 14, 'باتيه فرنسي طازج وخفيف.', 'Plain Patisserie.png'),
(116, 116, 'Cheese Patisserie | باتيه جبنة', 14, 'باتيه محشو بجبنة ذائبة.', 'Cheese Patisserie.png'),
(117, 117, 'White Cheese Patisserie | باتيه جبنة بيضاء', 14, 'باتيه محشو بجبنة بيضاء كريمية.', 'White Cheese Patisserie.png'),
(118, 118, 'Luncheon Patisserie | باتيه لانشون', 14, 'باتيه محشو باللانشون والجبنة.', 'Luncheon Patisserie.png'),
(119, 119, 'Smoked Turkey Patisserie | باتيه تركي مدخن', 14, 'باتيه مع صدر رومي مدخن وجبنة.', 'Smoked Turkey Patisserie.png'),
(120, 120, 'Mixed Cheese Patisserie | باتيه جبن مشكل', 14, 'باتيه محشو بتشكيلة من الأجبان.', 'Mixed Cheese Patisserie.png'),
(121, 121, 'Cookies | كوكيز', 14, 'كوكيز متنوع ومحلى طازجاً.', 'Cookies.png'),
(122, 122, 'Cookies Nuts | كوكيز مكسرات', 14, 'كوكيز مقرمش مع حبات المكسرات.', 'Cookies Nuts.png');
INSERT INTO product_prices (product_id, size_id, price) VALUES
(108, 2, 35),
(109, 2, 50),
(110, 2, 60),
...
INSERT INTO products (product_id, product_id, product_name, category_id, description_ar, image_url) VALUES
(162, 162, 'Sandwich 1 | ساندويتش 1', 19, 'ساندويتش لذيذ سيتم تحديث تفاصيله لاحقاً.', 'default.jpg'),
(163, 163, 'Sandwich 2 | ساندويتش 2', 19, 'ساندويتش لذيذ سيتم تحديث تفاصيله لاحقاً.', 'default.jpg'),
(164, 164, 'Sandwich 3 | ساندويتش 3', 19, 'ساندويتش لذيذ سيتم تحديث تفاصيله لاحقاً.', 'default.jpg'),
(165, 165, 'Sandwich 4 | ساندويتش 4', 19, 'ساندويتش لذيذ سيتم تحديث تفاصيله لاحقاً.', 'default.jpg');
...
/* =========================
   ...
   ========================= */
INSERT INTO products (product_id, product_id, product_name, category_id, description_ar, image_url) VALUES
(166, 166, 'Cinnamon Roll | سينامون', 13, 'رول قرفة طازج بعجينة ناعمة وصوص كريمي.', 'default.jpg');
